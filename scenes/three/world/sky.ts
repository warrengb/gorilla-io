...
export class Sky extends THREE.Object3D  {
  ...
  constructor(world: THREE.Scene, camera: THREE.PerspectiveCamera | THREE.OrthographicCamera) {
    super();
    ...
    // Legacy
    let splitsCallback = (amount: number, near: any, far: any) => {
      let arr = [];
